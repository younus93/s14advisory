<div class="row mt-40">
    <div class="col-md-3 col-sm-3 col-12">
        <div class="feature-block-2 feature-bordered feature-shadow feature-bg inner-40 left-holder">
            ...
            <h4>Fund Raising</h4>
            <p>Equity placement or recapitalization through our extensive network for a private placement or Pre initial public offering (IPO)</p>
        </div>
    </div>
    <div class="col-md-3 col-sm-3 col-12">
        <div class="feature-block-2 feature-bordered feature-shadow feature-bg inner-40 left-holder">
    ...
    <div class="col-md-3 col-sm-3 col-12">
        <div class="feature-block-2 feature-bordered feature-shadow feature-bg inner-40 left-holder"><i
            ...
            <h4>IFA Service</h4>
            <p>Provides independent analyses on financial perspective allows our clients to make fully informed business decisions.</p>
        </div>
    </div>
    <div class="col-md-3 col-sm-3 col-12">
        <div class="feature-block-2 feature-bordered feature-shadow feature-bg inner-40 left-holder"><i class="icon-bank"></i>
            <h4>IPO advisory</h4>
        ...
        <div class="row mt-40">
            ...
            <div class="col-md-3 col-sm-3 col-12">
                <div class="feature-block-2 feature-bordered feature-shadow feature-bg inner-40 left-holder"><i
                    ...
                    <h4>IFA Service</h4>
                    <p>Render the opinion regarding the reasonableness of the transactions and the fairness of the
                        price and conditions of the transactions.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-sm-4 col-12">
                <div class="feature-block-2 feature-bordered feature-shadow feature-bg inner-40 left-holder"><i
                    ...
                    <p>Provides services at all stages of preparing for an IPO and transforming a company from
                        private into a public entity.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-12">
                <div class="feature-block-2 feature-bordered feature-shadow feature-bg inner-40 left-holder"><i
